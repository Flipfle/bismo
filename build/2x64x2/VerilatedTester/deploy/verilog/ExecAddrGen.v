...
(* CORE_GENERATION_INFO="ExecAddrGen,hls_ip_2018_3_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.897312,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=982,HLS_SYN_LUT=444,HLS_VERSION=2018_3_1}" *)
...
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start;
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_done;
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_idle;
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_ready;
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_in_V_V_TVALID;
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_in_V_V_TREADY;
wire   [47:0] grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TDATA;
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TVALID;
wire    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TREADY;
reg    grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start_reg;
...
#0 grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
end

ExecAddrGen_Templated_1ul_16ul_0ul_s grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start),
    .ap_done(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_done),
    .ap_idle(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_idle),
    .ap_ready(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_ready),
    .in_V_V_TDATA(in_V_V_0_data_out),
    .in_V_V_TVALID(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_in_V_V_TVALID),
    .in_V_V_TREADY(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_in_V_V_TREADY),
    .out_V_V_TDATA(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TDATA),
    .out_V_V_TVALID(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TVALID),
    .out_V_V_TREADY(grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TREADY)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start_reg <= 1'b1;
        end else if ((grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_ready == 1'b1)) begin
            grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((out_V_V_1_load_A == 1'b1)) begin
        out_V_V_1_payload_A <= grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((out_V_V_1_load_B == 1'b1)) begin
        out_V_V_1_payload_B <= grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TDATA;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        in_V_V_0_ack_out = grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_in_V_V_TREADY;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_done == 1'b1))) begin
...
assign grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start = grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_ap_start_reg;

assign grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_in_V_V_TVALID = in_V_V_0_state[1'd0];

assign grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TREADY = (out_V_V_1_ack_in & ap_CS_fsm_state3);
...
assign out_V_V_1_vld_in = grp_ExecAddrGen_Templated_1ul_16ul_0ul_s_fu_26_out_V_V_TVALID;
